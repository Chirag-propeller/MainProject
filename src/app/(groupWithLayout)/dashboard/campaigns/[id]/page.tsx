...
export default function CampaignDetailsPage() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col bg-white rounded-lg border border-t-0 border-gray-200 h-full animate-pulse dark:bg-gray-900 dark:text-gray-200 dark:border-gray-700">
        {/* Header skeleton */}
        <div className="flex justify-between items-start p-4 pb-1">
          <div className="flex flex-col">
            <div className="h-8 bg-gray-200 rounded w-64 mb-2 dark:bg-gray-700"></div>
            <div className="flex items-center gap-2">
              <div className="h-3 bg-gray-200 rounded w-32 dark:bg-gray-700"></div>
              <div className="h-5 bg-gray-200 rounded-full w-16 dark:bg-gray-700"></div>
            </div>
          </div>
          <div className="flex space-x-2 gap-1">
            <div className="h-9 bg-gray-200 rounded w-20 dark:bg-gray-700"></div>
            <div className="h-9 bg-gray-200 rounded w-16 dark:bg-gray-700"></div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="space-y-4">
              ...
              <div className="p-4 bg-white dark:bg-gray-900">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[...Array(6)].map((_, i) => (
                    <div
                      key={i}
                      className="bg-gray-50 p-3 rounded-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700"
                    >
                      <div className="h-3 bg-gray-200 rounded w-20 mb-2 dark:bg-gray-700"></div>
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden dark:border-gray-700">
              <div className="p-2 bg-gray-50 dark:bg-gray-800">
                <div className="h-5 bg-gray-200 rounded w-28 dark:bg-gray-700"></div>
              </div>
            </div>
          </div>
        </div>
