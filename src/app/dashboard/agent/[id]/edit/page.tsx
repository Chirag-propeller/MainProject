    ...
    <div className='bg-gray-100 dark:bg-gray-900 h-fit min-h-screen'>
      <div className='flex bg-gray-100 dark:bg-gray-900 h-[90vh] w-full'>
              ...
              <div className='text-gray-500 dark:text-gray-400 m-2 mx-3'>
                ...
                <ul className='list-disc pl-5'>
                {
                  knowledgeBaseList.map((li) => {
                    ...
                    return (
                      <li key={li} className='text-sm text-gray-700 dark:text-gray-300'>
                      {kb?.name || 'Unknown'}
                    </li>
                    )
                  }
        ...
        <div className=' flex justify-center '>
          ...
          <button
            className="white cursor-pointer border-1 p-1 px-10 rounded-sm border-gray-400 dark:border-gray-600 bg-white dark:bg-gray-800 mb-5 m-2 text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
