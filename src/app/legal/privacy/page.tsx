    ...
    <main className='min-h-screen !bg-white'>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 !text-gray-800">
        ...
        <p className="mb-6 !text-gray-700">
          Propeller Global Ventures Pvt. Ltd. ("Propeller," "we," "us," or "our") operates the website <strong className="!text-gray-900">www.propalai.com</strong> and its associated services (collectively, the "Platform"). This Privacy Policy describes how we collect, use, share, store, and protect personal information in compliance with Indian law and applicable international data protection principles.
        </p>
        <p className="mb-6 !text-gray-700">By using our Platform, you consent to the practices outlined in this Policy.</p>

        <h2 className="text-xl font-semibold mt-8 mb-2 !text-gray-900">1. Information We Collect</h2>

        <h3 className="font-semibold mt-4 !text-gray-800">a. Personal Information</h3>
        <p className="mb-2 !text-gray-700">Includes data such as:</p>
        ...
        <h3 className="font-semibold mt-4 !text-gray-800">b. Sensitive Personal Data or Information (SPDI)</h3>
        <p className="mb-2 !text-gray-700">As per Rule 3 of the IT Rules, 2011, this includes:</p>
        <ul className="list-disc list-inside mb-4 !text-gray-700">
          <li>Passwords</li>
          <li>Financial details (e.g., bank or card information)</li>
          <li>Physical, physiological, or mental health conditions</li>
        ...
        <p className="mb-4 !text-gray-700">We will <strong className="!text-gray-900"> obtain explicit consent </strong>before collecting or using any SPDI.</p>

        <h3 className="font-semibold mt-4 !text-gray-800">c. Usage and Device Data</h3>
        <p className="mb-2 !text-gray-700">Collected automatically:</p>
        <ul className="list-disc list-inside mb-4 !text-gray-700">
          <li>IP address, browser type, device identifiers</li>
          <li>Operating system, pages visited, time spent</li>
          <li>Crash logs, diagnostic data</li>
        ...
        <h3 className="font-semibold mt-4 !text-gray-800">d. Location Information</h3>
        <p className="mb-4 !text-gray-700">
          With your permission, we may collect and use real-time location data for customized service delivery. You can manage location permissions via your device settings.
        </p>

        <h3 className="font-semibold mt-4 !text-gray-800">e. Cookies & Tracking Technologies</h3>
        <p className="my-2 mb-1 !text-gray-700">We use:</p>
        <ul className="list-disc list-inside mb-3 !text-gray-700">
          <li><strong className="!text-gray-900">Session Cookies </strong>(platform functionality)</li>
          <li><strong className="!text-gray-900">Preference Cookies </strong>(remember settings)</li>
          <li><strong className="!text-gray-900">Analytics Cookies </strong>(usage patterns)</li>
          <li><strong className="!text-gray-900">Security Cookies </strong></li>
          <li><strong className="!text-gray-900">Advertising Cookies </strong>(where applicable)</li>
        </ul>
        <p className="mb-4 mt-0 !text-gray-700">You may disable cookies in your browser; however, some features may become unavailable.</p>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-2 !text-gray-900">3. Consent and Right to Withdraw</h2>
        <p className="mb-4 !text-gray-700">
          You may withdraw consent for the collection and processing of your personal or sensitive personal data at any time by writing to <a href="mailto:support@propalai.com" className="text-blue-600 dark:text-blue-400 underline hover:text-blue-800 dark:hover:text-blue-300">support@propalai.com</a>. Withdrawal may impact your ability to access certain features or services.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2 !text-gray-900">4. Disclosure of Information</h2>
        <p className="mb-2 !text-gray-700">We do<strong className="!text-gray-900"> not sell</strong> your data. We may share it:</p>
        <ul className="list-disc list-inside mb-4 !text-gray-700">
          <li>With trusted service providers under confidentiality agreements</li>
          <li>To enforce terms of service</li>
          <li>When required by law or government order</li>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-2 !text-gray-900">5. Data Transfers</h2>
        <p className="mb-4 !text-gray-700">
          If your data is transferred outside India, we ensure the recipient offers a level of data protection equivalent to Indian law, as mandated under Rule 7. Transfers occur only with your consent or under lawful contractual necessity.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2 !text-gray-900">6. Data Retention</h2>
        <p className="mb-2 !text-gray-700">We retain data as long as:</p>
        <ul className="list-disc list-inside mb-4 !text-gray-700">
          <li>Required to deliver our services</li>
          <li>Necessary for legal, regulatory, or tax purposes</li>
          <li>Needed to resolve disputes or enforce our terms</li>
        </ul>
        <p className="mb-4 !text-gray-700">Anonymized usage data may be retained for analytics and performance monitoring.</p>

        <h2 className="text-xl font-semibold mt-8 mb-2 !text-gray-900">7. Your Rights</h2>
        ...
        <p className="mb-4 !text-gray-700">To exercise these rights, contact <a href="mailto:support@propalai.com" className="text-blue-600 dark:text-blue-400 underline hover:text-blue-800 dark:hover:text-blue-300">support@propalai.com</a>.</p>

        <h2 className="text-xl font-semibold mt-8 mb-2 !text-gray-900">8. Reasonable Security Practices</h2>
        <ul className="list-disc list-inside mb-4 !text-gray-700">
          <li>Secure servers and encrypted transmissions</li>
          <li>Access control and audit trails</li>
          <li>Regular vulnerability assessments and security audits</li>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-2 !text-gray-900">9. Grievance Officer</h2>
        <p className="mb-4 !text-gray-700">
          As per Rule 5(9), we have appointed a Grievance Officer:
          <br />
          Name: Ashish Chandra<br />
          Email: <a href="mailto:support@propalai.com" className="text-blue-600 dark:text-blue-400 underline hover:text-blue-800 dark:hover:text-blue-300">support@propalai.com</a><br />
          Phone: +919021342078
          <br />
          Complaints will be addressed within 30 days of receipt.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2 !text-gray-900">10. Children's Privacy</h2>
        <p className="mb-4 !text-gray-700">
          Our services are not intended for children under 16. We do not knowingly collect data from minors. If identified, such data will be deleted promptly.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2 !text-gray-900">11. Email Communication</h2>
        <p className="mb-4 !text-gray-700">
          You may receive service updates, alerts, or promotional emails. You can opt out anytime by using the "unsubscribe" link or contacting <a href="mailto:support@propalai.com" className="text-blue-600 dark:text-blue-400 underline hover:text-blue-800 dark:hover:text-blue-300">support@propalai.com</a>.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2 !text-gray-900">12. Changes to this Policy</h2>
        <p className="mb-4 !text-gray-700">
          We may update this Privacy Policy periodically. Any material changes will be notified on our website or by email. Continued use of our services after such changes constitutes your agreement to the updated policy.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2 !text-gray-900">13. Contact Us</h2>
        <p className="mb-4 !text-gray-700">
          Propeller Global Ventures Pvt. Ltd.<br />
          B1-401, Kanakia Boomerang, Chandivali Road<br />
          Powai, Mumbai, Maharashtra, India – 400072<br />
          📧 <a href="mailto:support@propalai.com" className="text-blue-600 dark:text-blue-400 underline hover:text-blue-800 dark:hover:text-blue-300">support@propalai.com</a>
        </p>
      </div>
    </main>
  );
