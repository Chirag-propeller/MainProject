  ...
  return (
    <main className="light-only">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 text-gray-800">
        ...
        <p className="mb-6">
          Propeller Global Ventures Pvt. Ltd. (“Propeller,” “we,” “us,” or
          “our”) operates the website <strong>www.propalai.com</strong> and its
          associated services (collectively, the “Platform”). This Privacy
          Policy describes how we collect, use, share, store, and protect
          personal information in compliance with Indian law and applicable
        ...
        <h3 className="font-semibold mt-4">a. Personal Information</h3>
        <p className="mb-2">Includes data such as:</p>
        <ul className="list-disc list-inside mb-4">
          <li>Full name</li>
          <li>Email address</li>
          <li>Phone number</li>
          ...
          <li>Government-issued ID (if applicable)</li>
          <li>
            Information shared through forms, contact pages, or account
            registration
          </li>
        </ul>
        ...
        <p className="mb-2">
          As per Rule 3 of the IT Rules, 2011, this includes:
        </p>
        <ul className="list-disc list-inside mb-4">
          <li>Passwords</li>
          <li>Financial details (e.g., bank or card information)</li>
          ...
          <li>Biometric identifiers</li>
          <li>
            Any information relating to the above, collected for providing a
            service
          </li>
        </ul>
        <p className="mb-4">
          We will <strong> obtain explicit consent </strong>before collecting or
          using any SPDI.
        </p>
        ...
        <h3 className="font-semibold mt-4">d. Location Information</h3>
        <p className="mb-4">
          With your permission, we may collect and use real-time location data
          for customized service delivery. You can manage location permissions
        ...
        <p className="my-2 mb-1">We use:</p>
        <ul className="list-disc list-inside mb-3">
          <li>
            <strong>Session Cookies </strong>(platform functionality)
          </li>
          <li>
            <strong>Preference Cookies </strong>(remember settings)
          </li>
          <li>
            <strong>Analytics Cookies </strong>(usage patterns)
          </li>
          <li>
            <strong>Security Cookies </strong>
          </li>
          <li>
            <strong>Advertising Cookies </strong>(where applicable)
          </li>
        </ul>
        <p className="mb-4 mt-0">
          You may disable cookies in your browser; however, some features may
          become unavailable.
        </p>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>Personalize your experience</li>
          <li>
            Send transactional, account-related, or promotional communications
          </li>
          <li>Analyze trends and monitor performance</li>
          <li>Comply with legal obligations</li>
          <li>Prevent fraud or abuse</li>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-2">
          3. Consent and Right to Withdraw
        </h2>
        <p className="mb-4">
          You may withdraw consent for the collection and processing of your
          personal or sensitive personal data at any time by writing to{" "}
          <a
          ...
          . Withdrawal may impact your ability to access certain features or
          services.
        </p>
        ...
        <p className="mb-2">
          We do<strong> not sell</strong> your data. We may share it:
        </p>
        <ul className="list-disc list-inside mb-4">
          <li>
        ...
        <p className="mb-4">
          SPDI will only be disclosed with your prior consent or under legal
          compulsion as per Rule 6 of the IT Rules.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2">5. Data Transfers</h2>
        <p className="mb-4">
          If your data is transferred outside India, we ensure the recipient
          offers a level of data protection equivalent to Indian law, as
          mandated under Rule 7. Transfers occur only with your consent or under
          lawful contractual necessity.
        </p>
        ...
        <p className="mb-4">
          Anonymized usage data may be retained for analytics and performance
          monitoring.
        </p>
        ...
        <p className="mb-4">
          ...
          knowingly collect data from minors. If identified, such data will be
          deleted promptly.
        </p>
        ...
        <p className="mb-4">
          You may receive service updates, alerts, or promotional emails. You
          can opt out anytime by using the “unsubscribe” link or contacting{" "}
          <a
            href="mailto:support@propalai.com"
            className="text-blue-600 underline"
          >
        ...
        <p className="mb-4">
          ...
          will be notified on our website or by email. Continued use of our
          services after such changes constitutes your agreement to the updated
          policy.
        </p>
