...
const RechargeSection = () => {
  ...
  return (
    <Card className="h-full" id="recharge">
      <CardHeader className="pb-2">
        <CardTitle className="text-xl font-semibold text-gray-800">Recharge Account</CardTitle>
      </CardHeader>
      <CardContent>
            ...
            {RECHARGE_OPTIONS.map(option => (
              <Button
                ...
                className={`
                  ...
                  ${selectedAmount === option.value ? 'ring-2 ring-indigo-300' : ''}
                `}
