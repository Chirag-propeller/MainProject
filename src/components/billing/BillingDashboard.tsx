...
const BillingDashboard = () => {
  ...
  useEffect(() => {
    const fetchUserBalance = async () => {
      ...
      const creditsUsed =
        parseFloat(user.data?.creditsUsed?.$numberDecimal) || 0;
  ...
  if (loading) {
    return (
      <div className="container mx-auto p-6 max-w-7xl bg-white dark:bg-gray-900">
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl bg-white dark:bg-gray-900">
      <h1 className="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-300">
        Billing & Usage
      </h1>
