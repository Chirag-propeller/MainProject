    ...
    <Card className="h-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-[6px]">
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        {balanceStatus !== "healthy" && (
          <Button
            variant="ghost"
            size="sm"
            className={`${balanceStatus === "danger" ? "text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-900" : "text-yellow-600 hover:text-yellow-700 hover:bg-yellow-50 dark:hover:bg-yellow-900"}`}
      ...
      <CardContent>
        <div className="flex items-baseline mt-4">
          <div
            className={`text-5xl font-bold text-indigo-500 dark:text-indigo-300 ${statusStyles[balanceStatus]}`}
          >
            ${balance.toFixed(2)}
          </div>
        ...
        <div
          className={`text-sm mt-2 text-indigo-500 dark:text-indigo-300 ${statusStyles[balanceStatus]}`}
        >
          {balanceStatus === "danger"
