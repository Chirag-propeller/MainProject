      ...
      >
        <div className="flex justify-between">
          <div className="flex gap-2">
            <Bot className="w-3.5 h-3.5 text-gray-900 dark:text-indigo-300 self-center" />
          ...
          {loading ? (
            <div className="animate-pulse space-y-4">
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-white dark:bg-slate-800 p-3 rounded-md border border-gray-200 dark:border-gray-700">
                    <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded w-18 mb-2"></div>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-white dark:bg-slate-800 p-3 rounded-md border border-gray-200 dark:border-gray-700">
                    <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded w-10 mb-2"></div>
                    <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-16"></div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white dark:bg-slate-800 p-3 rounded-md border border-gray-200 dark:border-gray-700">
                  <div className="flex flex-col">
                    <div className="flex items-center gap-1 mb-1">
                      <User className="w-3 h-3 text-gray-500 dark:text-indigo-300" />
                      <span className="text-xs font-medium text-gray-500 dark:text-indigo-300 uppercase tracking-wide">
                        Agent Name
                      </span>
                    </div>
                    <span className="text-sm text-gray-900 dark:text-indigo-300 font-medium">
                ...
                <div className="bg-white dark:bg-slate-800 p-3 rounded-md border border-gray-200 dark:border-gray-700">
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm text-gray-900 dark:text-indigo-300 font-mono">
              ...
              {(agentDetails.llm || agentDetails.llmModel) && (
                <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                  <div className="flex items-center gap-1 mb-3">
                    <Brain className="w-4 h-4 text-gray-600 dark:text-indigo-300" />
                    <h3 className="text-sm font-semibold text-gray-700 dark:text-indigo-300">
                      Model Configuration
                    </h3>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {(agentDetails.tts ||
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                  <div className="flex items-center gap-1 mb-3">
                    <Speech className="w-4 h-4 text-gray-600 dark:text-indigo-300" />
                    <h3 className="text-sm font-semibold text-gray-700 dark:text-indigo-300">
                      Voice Configuration
                    </h3>
                  </div>
              ...
              {agentDetails.welcomeMessage && (
                <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                  <h3 className="text-sm font-semibold text-gray-700 dark:text-indigo-300 mb-3">
                    Welcome Message
                  </h3>
                  <div className="bg-white dark:bg-slate-800 p-4 rounded-md border border-gray-200 dark:border-gray-700">
                    <span className="text-sm text-gray-900 dark:text-indigo-300 leading-relaxed">
                      {agentDetails.welcomeMessage}
                    </span>
                  </div>
                </div>
