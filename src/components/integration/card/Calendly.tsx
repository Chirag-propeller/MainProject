...
type CalendlyCardProps = {
  onSuccess?: (response: any) => void;
  onError?: (error: any) => void;
};

const CalendlyCard: React.FC<CalendlyCardProps> = ({ onSuccess, onError }) => {
    const endpoint = "/api/integration/calendly/auth"
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        ...
        <p className="text-sm text-gray-500">Connect your Calendly to manage scheduled events.</p>
      </div>
