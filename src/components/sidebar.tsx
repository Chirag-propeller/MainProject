...
const UserCard = () => {
  ...
  if (loading) {
    return (
      <div className="w-44 p-3 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-950 dark:border-gray-700">
  ...
  return (
    <Link href="/dashboard/profile">
      <div className="w-44 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-lg border border-gray-200 cursor-pointer dark:bg-gray-950 dark:hover:bg-gray-700 dark:border-gray-700">
        <div className="flex items-center gap-2 mb-2">
          <div className="w-8 h-8 bg-indigo-100 rounded-full flex items-center justify-center dark:bg-indigo-900">
            <User className="w-4 h-4 text-indigo-600 dark:text-gray-100" />
          </div>
          <div className="flex-1 min-w-0">
            <h4 className="text-sm font-medium text-gray-900 truncate dark:text-gray-100">{user.name}</h4>
          </div>
        </div>
        
        <div className="space-y-1">
          <div className="flex items-center gap-1">
            <Mail className="w-3 h-3 text-gray-400 dark:text-gray-100" />
            <span className="text-xs text-gray-600 truncate dark:text-gray-100">{user.email}</span>
          </div>
          
          <div className="flex items-center gap-1">
            <Zap className="w-3 h-3 text-green-500 dark:text-gray-100" />
...
const Sidebar = ()=> {
  ...
  return (
    <aside className="w-52 h-[100vh] scroll overflow-y-auto text-gray-600 p-4 ps-0 pt-0 pb-10 fixed border-r border-gray-200 bg-white dark:bg-gray-950 dark:text-gray-300 dark:border-gray-800">
    {/* <aside className="w-64 h-screen fixed left-0 top-0 bg-white text-gray-600"> */}


        <div className="w-48 bg-white fixed border-b border-gray-200 dark:bg-gray-950 dark:border-gray-800">
