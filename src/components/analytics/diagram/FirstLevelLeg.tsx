...
const ThirdLevelCell = ({ data }: any) => {
  return (
    <div className={`relative h-[530px] w-46 border border-gray-400 border-l-8 border-l-indigo-400 rounded shadow bg-white text-xs font-medium flex flex-col justify-center items-center`}>
        <div className="text-center text-4xl text-indigo-500">
            {data.value}
        </div>
