      ...
      <table className="table-auto border-collapse w-full text-left ">
        <tbody>
          <tr>
            <td
              rowSpan={3}
              className={`font-bold text-center align-middle border-r dark:text-indigo-300 border-gray-400  px-2 text-wrap w-32 ${data.textColor}`}
            >
              {data.label}
            </td>
            <td className=" text-gray-500 dark:text-gray-300 pl-1 border-r border-b border-gray-400 px-2 w-32">
              {data?.tableHeading[0]}
            </td>
            <td
          ...
          <tr>
            <td className=" text-gray-500 pl-1 dark:text-gray-300 border-r border-b border-gray-400 px-2 w-32">
              {data?.tableHeading[1]}
            </td>
            <td
          ...
          <tr>
            <td className=" text-gray-500 pl-1 dark:text-gray-300 border-r border-gray-400 px-2 w-32">
              {data?.tableHeading[2]}
            </td>
            <td
